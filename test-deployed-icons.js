...
(async () => {
  ...
  console.log('Testing Icons on Fresh Deployment\n');
  ...
  try {
    ...
    if (hamburger) {
      ...
      // Check for home link in sidebar
      const homeLink = await page.$('a[href="/"]');
      console.log(`   Home link in sidebar: ${homeLink ? '✅' : '❌'}`);
    }

    await page.screenshot({ path: 'screenshots/deployed-icons-test.png', fullPage: true });
    console.log('\n   Screenshot saved');
